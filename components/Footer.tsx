  ...
  return (
    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 lg:grid-cols-4 lg:gap-8 gap-12 pt-14 pb-20 max-w-md mx-auto md:max-w-xl lg:max-w-full">
            <div className="block">
                <h4 className="text-xl text-white font-bold mb-7">Breaking News</h4>
            ...
            <div className="block">
                <h4 className="text-xl text-white font-bold mb-7">Pages</h4>
                <ul className="text-lg  transition-all duration-500">
                    <li className="mb-6"><a href="javascript:;"  className=" text-gray-400 hover:text-white">Latest News</a></li>
                    <li className="mb-6"><a href="javascript:;"  className=" text-gray-400 hover:text-white">About Us</a></li>
                    <li ><a href="javascript:;"  className=" text-gray-400 hover:text-white">Contact Us</a></li>
                </ul>
            </div>
            <div className="block">
                ...
                <ul className="text-lg  transition-all duration-500">
                    ...
                    <li className="mb-6"><a href="javascript:;"  className=" text-gray-400 hover:text-white">WWW</a></li>
                    <li className="mb-6"><a href="javascript:;"  className=" text-gray-400 hover:text-white">World Wide News </a></li>
        ...
        <div className="py-7 border-t border-gray-700 ">
            <div className="flex items-center justify-center flex-col lg:space-y-0 space-y-8 lg:justify-between lg:flex-row">
                <a href="https://Breaking News.io/"  className="flex justify-center ">
          <Image className="h-12 w-auto" src="/newsLogo.png" alt="Your Company" width={100} height={100}/>
                </a>
                <span className="text-gray-400  block">©
<a href="https://Breaking News.io/">Breaking News</a> 2024, All rights reserved.</span>
